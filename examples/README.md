...
| `pilot_dossier.py` | **Satış numunesi üreticisi**: yayımlanmış gerçek karne (qwen2.5:3b JBB-40) → tam Annex XI dosyası + CoP + SHA-256 kanıt-zinciri → `pilot/` | ağ yok; beyan-eksik alanlar köşeli-parantezli kalır (uydurma-yok) |
